...
import sys
from PySide6.QtWidgets import (QAbstractButton, QApplication, QVBoxLayout,QComboBox, QDialogButtonBox,
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_4.setGeometry(QRect(730, 0, 231, 191))
        font = QFont()
        ...
        self.label_13.setGeometry(QRect(10, 60, 81, 16))
        font1 = QFont()
        ...
        self.buttonBox.setGeometry(QRect(10, 590, 341, 32))
        self.buttonBox.setOrientation(Qt.Orientation.Horizontal)
        self.buttonBox.setStandardButtons(QDialogButtonBox.StandardButton.Cancel|QDialogButtonBox.StandardButton.Ok)
        self.groupBox_6 = QGroupBox(self.centralwidget)
        self.groupBox_6.setObjectName(u"groupBox_6")
        self.groupBox_6.setGeometry(QRect(730, 200, 701, 531))
        self.groupBox_6.setFont(font)
        self.groupBox_6.setAutoFillBackground(True)
        self.webEngineView = QWebEngineView(self.groupBox_6)
        self.webEngineView.setObjectName(u"webEngineView")
        self.webEngineView.setGeometry(QRect(0, 20, 701, 511))
        self.webEngineView.setUrl(QUrl(u"about:blank"))
        self.groupBox_7 = QGroupBox(self.centralwidget)
        self.groupBox_7.setObjectName(u"groupBox_7")
        self.groupBox_7.setGeometry(QRect(970, 0, 451, 191))
        ...
        self.label_17.setGeometry(QRect(10, 70, 58, 16))
        self.pushButton = QPushButton(self.groupBox_7)
        self.pushButton.setObjectName(u"pushButton")
        self.pushButton.setGeometry(QRect(160, 160, 100, 32))
        ...
        self.groupBox_7 = QGroupBox(self.centralwidget)
        self.groupBox_7.setObjectName(u"groupBox_7")
        self.groupBox_7.setGeometry(QRect(10, 590, 711, 100))
        self.groupBox_7.setFont(font)
        self.groupBox_7.setAutoFillBackground(True)
        self.groupBox_7.setTitle("Bağlantı Bilgileri")

        self.label_ip = QLabel(self.groupBox_7)
        self.label_ip.setObjectName(u"label_ip")
        self.label_ip.setGeometry(QRect(10, 30, 81, 16))
        self.label_ip.setFont(font1)
        self.label_ip.setText("IP Adresi:")

        self.lineEdit_ip = QLineEdit(self.groupBox_7)
        self.lineEdit_ip.setObjectName(u"lineEdit_ip")
        self.lineEdit_ip.setGeometry(QRect(100, 30, 200, 31))

        self.label_port = QLabel(self.groupBox_7)
        self.label_port.setObjectName(u"label_port")
        self.label_port.setGeometry(QRect(310, 30, 81, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"U\u00c7AK:", None))
        self.comboBox.setItemText(0, QCoreApplication.translate("MainWindow", u"GRIFFIN", None))
        self.comboBox.setItemText(1, QCoreApplication.translate("MainWindow", u"MERKUT", None))
        ...
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"HIZ:", None))
        ...
        self.groupBox_7.setTitle(QCoreApplication.translate("MainWindow", u"SUNUCU BA\u011eLANTISI", None))
        self.label_16.setText(QCoreApplication.translate("MainWindow", u"IP Adresi:", None))
        ...
        self.groupBox_7.setTitle(QCoreApplication.translate("MainWindow", u"Bağlantı Bilgileri", None))
